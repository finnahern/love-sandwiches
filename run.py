...
def get_sales_data():
    ...
    by commas. The loop will repeat the request for data until a valid
    string is input.
    """
    while True:
...
def calculate_surplus_data(sales_row):
    ...
    The surplus is defined as the sales figure subtracted fromt the stock:
...
def get_stock_values(data):
    ...
    for heading, stock in zip(headings, data):
        stock_values_dict.update({heading: stock})
